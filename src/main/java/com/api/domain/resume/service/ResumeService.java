	...
	public List<ResumeListDto> getAllResumes() {
		...
		return resumes.stream()
				.map(resume -> new ResumeListDto(
						resume.getId(),
						XorDecryptUtil.xorDecrypt(resume.getSchool(), encryptionKey),
						XorDecryptUtil.xorDecrypt(resume.getStatus(), encryptionKey),
						XorDecryptUtil.xorDecrypt(resume.getPersonal(), encryptionKey),
						XorDecryptUtil.xorDecrypt(resume.getWork_place_region(), encryptionKey),
						XorDecryptUtil.xorDecrypt(resume.getWork_place_city(), encryptionKey),
						XorDecryptUtil.xorDecrypt(resume.getIndustry_occupation(), encryptionKey),
						XorDecryptUtil.xorDecrypt(resume.getEmploymentType(), encryptionKey),
						XorDecryptUtil.xorDecrypt(resume.getWorking_period(), encryptionKey),
						XorDecryptUtil.xorDecrypt(resume.getWorking_day(), encryptionKey),
						XorDecryptUtil.xorDecrypt(resume.getIntroduction(), encryptionKey),
